  ...
  return (
    <>
      ...
      <div className="flex h-full justify-center">
        <div className="w-2/3">
          <div className="bg-white shadow-md rounded px-4 py-6 mb-5 mt-20">
            <div className="h-1/2 w-full pt-8">
              <div className="flex items-end justify-between">
                ...
                <Button
                  className="text-sm bg-orange-500 hover:bg-orange-700 text-white font-bold py-2 px-4 rounded"
          ...
          <div className="bg-white shadow-md rounded px-4 py-6 mb-5">
